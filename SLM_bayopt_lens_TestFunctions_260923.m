...
%% Main loop
Zern_amplitudes_1 = optimizableVariable("Zernikamplitudes_foc",[-0.7,-0.6],"Type","real")
Zern_amplitudes_2 = optimizableVariable("Zernikamplitudes_comma1",[-0.02,0.0],"Type","real")
Zern_amplitudes_3 = optimizableVariable("Zernikamplitudes_comma2",[-0.02,0.0],"Type","real")
Zern_amplitudes_4 = optimizableVariable("Zernikamplitudes_astig1",[0.15,0.25],"Type","real")
Zern_amplitudes_5 = optimizableVariable("Zernikamplitudes_astig2",[0.05,0.15],"Type","real")

max_count_h = @(x)peak_intensity(x)
results = bayesopt(max_count_h,[Zern_amplitudes_1,Zern_amplitudes_4,Zern_amplitudes_5])
max_count_h(results.XAtMinObjective)
results.XAtMinObjective
%% Objective function
function max_count = peak_intensity(xx)%TAKE PICTURE
    ...
    HoloL = lens + zernike(pist, x_tilt , y_tilt , xx.Zernikamplitudes_foc , xx.Zernikamplitudes_astig1, xx.Zernikamplitudes_astig2, 0 ,0, spher, H,V,RHO,PHI);
