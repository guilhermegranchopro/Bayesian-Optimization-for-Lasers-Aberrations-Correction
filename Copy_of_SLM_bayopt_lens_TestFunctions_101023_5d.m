...
results = bayesopt(max_count_h,[Zern_amplitudes_1,Zern_amplitudes_2,Zern_amplitudes_3,Zern_amplitudes_4,Zern_amplitudes_5],'MaxObjectiveEvaluations',60);
...
function max_count = peak_intensity(xx,cam)%TAKE PICTURE
    ...
    HoloL = lens + zernike(pist, x_tilt , y_tilt , xx.Zernikamplitudes_foc , xx.Zernikamplitudes_astig1,  xx.Zernikamplitudes_astig2 , xx.Zernikamplitudes_comma1 , xx.Zernikamplitudes_comma2 , spher, H,V,RHO,PHI);
